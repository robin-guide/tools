              ...
              <div className="flex items-start gap-4">
                <div className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center ${
                  ...
                  <svg className={`w-5 h-5 ${
                    params.scale === 4 ? 'text-amber-400' : 'text-blue-400'
                ...
                <div className="flex-1">
                  <h3 className={`text-sm font-medium ${
                    ...
                    {params.scale === 4 ? '⚠️ High Memory Usage' : 'Best Quality Selected'}
                  </h3>
                  <p className={`text-xs mt-1 ${
                    params.scale === 4 ? 'text-amber-400/70' : 'text-blue-400/70'
                  }`}>
                    {params.scale === 4 
                      ? '4x upscaling with Best quality is very memory-intensive and may fail. Try 2x or 3x scale, or use "High" quality instead.'
